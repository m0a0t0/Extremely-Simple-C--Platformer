...
namespace Platformer
{
	...
	public class EffectDie : Effect {
		...
		public EffectDie ()
		{
			xDirRange = new Vector (new PointF (-1.0f, 1.0f));
			yDirRange = new Vector (new PointF (-1.0f, 1.0f));
			xSpeedRange = new Vector (new Point (200, 250));
			ySpeedRange = new Vector (new Point (200, 250));	
			numberRange = new Vector (new Point (50, 100));
			xStopRange = new Vector (new Point (Player.WIDTH*2, Player.WIDTH*4));
			yStopRange = new Vector (new Point (Player.HEIGHT*2, Player.HEIGHT*4));//(Tile.HEIGHT - 5, Tile.HEIGHT-2));
